...
ALLOWED_HOSTS = ['192.168.0.100', '127.0.0.1','5749-103-109-53-5.in.ngrok.io', 'medsavvy.onrender.com']
...
# Additional locations of static files (your project-level static dir)
STATICFILES_DIRS = [
